...
function GoToEditView(id) {
    ...
    window.location.href = '/EditProduct/Edit/' + id;

}
function GoToEditView1(id) {
    $.ajax({
        url: 'Backend/Products/Edit/Edit',
        dataType: "json",
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                ...
                success: function (responseMessage) {
                    swal.fire("Done!", "Row " + id + " has been deleted successfully", '', "success");
                    $('#ProductsDatatable').DataTable().ajax.reload(null, false);
                }
            })
        } else {
...
function ViewData(id) {
    window.location.href = '/ViewProducts/ViewData/' + id;
}
////////////////////////////////////////////////////////////
