...
function GoToEditView1(id) {
    $.ajax({
        url: 'Backend/Services/Edit/Edit',
        dataType: "json",
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                ...
                success: function (responseMessage) {
                    swal.fire("Done!", "Row " + id + " has been deleted successfully", '', "success");
                    $('#ServicesDatatable').DataTable().ajax.reload(null, false);
                }
            })
        } else {
...
{
    window.location.href = '/ViewServices/ViewData/' + id;
}
////////////////////////////////////////////////////////////
